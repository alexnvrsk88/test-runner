...
namespace Grace.DependencyInjection.Impl
{
    ...
    public class ActivationStrategyDelegateCache
    {
        ...
        public void EnsureTypeActivatorDelegateExists(Type type, IExportLocatorScope scope)
        {
            if (scope.GetInjectionScope() is InjectionScope injectionScope)
            {
                injectionScope.EnsureTypeActivatorDelegateExists(type);
            }
        }
    }
}
