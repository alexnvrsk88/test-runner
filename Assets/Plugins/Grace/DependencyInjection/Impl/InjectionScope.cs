...
namespace Grace.DependencyInjection.Impl
{
    ...
    public class InjectionScope : BaseExportLocatorScope, IInjectionScope
    {
        ...
        public new void EnsureTypeActivatorDelegateExists(Type type)
        {
            var checkForMissingType = InternalFieldStorage.MissingExportStrategyProviders != ImmutableLinkedList<IMissingExportStrategyProvider>.Empty;
            var injectionContext = CreateInjectionContextFromExtraData(type, null);

            InternalFieldStorage.ActivationStrategyCompiler.FindDelegate(this, type, null, null, injectionContext, checkForMissingType);
        }
